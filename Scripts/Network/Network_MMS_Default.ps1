<#
 Author: soliloquy
 Version: 1.0
 Description: Restores multimedia scheduler settings (NetworkThrottlingIndex/SystemResponsiveness) to Windows defaults.
#>

Write-Host "Network - Restoring Multimedia Throttling defaults..."
...
Set-DW $reg "NetworkThrottlingIndex" 10
Set-DW $reg "SystemResponsiveness" 20